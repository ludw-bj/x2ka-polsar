...
class UnalignedDataset(BaseDataset):
    ...
    It requires two directories to host training images from domain A '/path/to/data/train/A'
    and from domain B '/path/to/data/train/B' respectively.
    You can train the model with the dataset flag '--dataroot /path/to/data'.
    Similarly, you need to prepare two directories:
    '/path/to/data/test/A' and '/path/to/data/test/B' during test time.
    """
