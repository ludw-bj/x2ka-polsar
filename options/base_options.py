...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='cycle_gan', help='chooses which model to use. [cycle_gan | pix2pix | perceptual | test]')
    ...
    def parse(self):
        ...
        # modify visdom-related parser options
        if self.isTrain:
